  ...
  methods: {
    ...
    cancel_invoice() {
      ...
      if (doc.name && this.pos_profile.posa_allow_delete) {
        frappe.call({
          method: "posawesomes.posawesomes.api.posapp.delete_invoice",
    ...
    async get_invoice_from_order_doc() {
      ...
      if (this.invoice_doc.doctype == "Sales Order") {
        await frappe.call({
          method:
            "posawesomes.posawesomes.api.posapp.create_sales_invoice_from_order",
          args: {
    ...
    update_invoice(doc) {
      const vm = this;
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.update_invoice",
        args: {
          data: doc,
        },
        async: false,
    ...
    update_invoice_from_order(doc) {
      const vm = this;
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.update_invoice_from_order",
        args: {
          data: doc,
        },
        async: false,
    ...
    async show_payment() {
      ...
      if (this.invoice_doc.doctype == "Sales Order") {
        ...
        frappe.call({
          method:
            "posawesomes.posawesomes.api.posapp.get_sales_invoice_child_table",
          args: {
    ...
    get_draft_invoices() {
      const vm = this;
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.get_draft_invoices",
        args: {
    ...
    get_draft_orders() {
      const vm = this;
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.search_orders",
        args: {
    ...
    update_items_details(items) {
      ...
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.get_items_details",
        async: false,
        args: {
    ...
    update_item_detail(item) {
      ...
      const vm = this;
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.get_item_detail",
        args: {
    ...
    fetch_customer_details() {
      ...
      if (this.customer) {
        frappe.call({
          method: "posawesomes.posawesomes.api.posapp.get_customer_info",
          args: {
    ...
    set_delivery_charges() {
      ...
      frappe.call({
        method:
          "posawesomes.posawesomes.api.posapp.get_applicable_delivery_charges",
        args: {
          company: this.pos_profile.company,
          pos_profile: this.pos_profile.name,
          customer: this.customer,
