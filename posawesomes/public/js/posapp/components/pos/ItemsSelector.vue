              ...
              >
                <v-card hover="hover" @click="add_item(item)">
                  <v-img
                    :src="
                      item.image ||
                      '/assets/posawesomes/js/posapp/components/pos/placeholder-image.png'
                    "
...
export default {
  ...
  methods: {
    ...
    get_items() {
      ...
      frappe.call({
        method: "posawesomes.posawesomes.api.posapp.get_items",
        args: {
    ...
    get_items_groups() {
      ...
      if (this.pos_profile.item_groups.length > 0) {
        ...
        const vm = this;
        frappe.call({
          method: "posawesomes.posawesomes.api.posapp.get_items_groups",
          args: {},
          callback: function (r) {
            if (r.message) {
